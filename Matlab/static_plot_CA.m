...
ylabel('Success rate');
legend(h1,'backtracking','congestion-aware','first-fit','next-fit','greedy','Location','SouthWest');
set(gca,'XLim',[2,10]);
...
xlabel('Number of VMs (N)');
ylabel('Success rate');
legend(h1,'backtracking','congestion-aware','first-fit','next-fit','greedy','allocation-range','Location','SouthWest');
set(gca,'XLim',[2,10]);
