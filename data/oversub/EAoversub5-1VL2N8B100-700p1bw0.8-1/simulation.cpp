...
void static_embedding_RA_N(char algorithm,bool enLProuting)
{
	...
	//input
	const int n=6,m=3;
	int numOfreq=10,n_test=n,k_paths[]={4,2,1,0}; 
...
//simulation of placement algorithms under oversubscription for N=2..10,B=100-700
		//static_embedding_oversub('P',enLProuting);
...
//simulation of routing algorithms for B=200-400,N=12
		//enLProuting=0;static_embedding_B('P',enLProuting);	
