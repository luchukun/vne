...
const float gbpsAgg2Int=gbpsToR2Agg*(DA/2)*oversubstription/(DI/2);//10Gbps
// DCN parameters
...
const bool en_limited_pertubation=true;
const bool en_limited_backtrack=true;
const int _max_pertubation=2;
const int _max_backtrack=2;
#endif