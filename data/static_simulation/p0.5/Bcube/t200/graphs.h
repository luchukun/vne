...
public:
	...
	float ProcessRequest(char algorithm,bool enLProuting,int numOfreq,float load,
						...
						;
	float SingleRequest(char algorithm,bool enLProuting,int numOfreq,float prob,int  numOfVM,float minBw,float maxBw,
	...
	float CongestDetect(Cluster& req,float* hostBw,Solution& map);
